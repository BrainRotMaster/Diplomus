...
[CreateAssetMenu(fileName = "Random Offset Node", menuName = "PCG/Nodes/Random Offset")]
public class PCGRandomOffsetNodeData : PCGNodeData
{
    ...
    public override string GetViewTypeName() => "PCGRandomOffsetNodeView";
}
